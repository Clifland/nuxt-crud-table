...
// resolves a header label for a rolled-up footer column (e.g. 'total_amount' -> 'Total Amount')
...
// --- child table footer: map footer defs onto the columns they target ---
