 ...
 */
export const NCT_API_HIDDEN_FIELDS = [
 ...
 */
export const NCT_DATA_TABLE_HIDDEN_FIELDS = [
 ...
 */
export const NCT_FORM_READ_ONLY_FIELDS = [] // id is managed in code as it should not be configurable accidently.

/**
 * Tables used by the engine.
 * These match the actual DB table names (usually snake_case or specific migration names).
 */
export const NCT_SYSTEM_TABLES = ['_hub_migrations', 'd1_migrations', 'sqlite_sequence']
