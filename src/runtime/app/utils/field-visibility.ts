 ...
 * @param {string} str - The field name to normalize.
 ...
 * @param {string[]} hiddenList - The resolved list of hidden field names.
 * @returns {boolean} True if the field should be considered hidden.
 */
 ...
 * ) // ['id', 'cost_price']
 * ```
 * @param {NctFieldVisibility | undefined} rule - The config value from `app.config.ts`'s `crud.tableHiddenFields`/`formHiddenFields`.
 * @param {string} resource - The current resource name, used to look up `resources[resource]`.
 * @param {string[]} [fallbackDefault] - The built-in default (e.g. `NCT_FORM_HIDDEN_FIELDS`) used when `rule` is unset or provides no `default` of its own.
 * @returns {string[]} The resolved, flat list of field names to hide.
 */
